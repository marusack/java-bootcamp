public class MyComplex {
	...
	public boolean equals(double real, double imag) {
		if ((Double.compare(real, this.getReal()) == 0) && (Double.compare(imag, this.getImag()) == 0)) {
			return true;
		} else {
			return false;
		}
	...
	public boolean equals(MyComplex another) {
		if ((Double.compare(another.getReal(), this.getReal()) == 0) && (Double.compare(another.getImag(), this.getImag()) == 0)) {
			return true;
		} else {
			return false;
		}
	...
	public double magnitude() {
		return (Math.sqrt((this.getImag() * this.getImag()) + (this.getReal() * this.getReal())));
	...
	public MyComplex conjugate() {
		MyComplex conjugate = new MyComplex(this.getReal(), -this.getImag());
		return (conjugate);
	}

	public MyComplex add(MyComplex another) {
		return (new MyComplex((another.getReal() + this.getReal()), (another.getImag() + this.getImag())));
	}
	...
	public MyComplex multiplyWith(MyComplex another) {
		return (new MyComplex((this.getReal() * another.getReal() - this.getImag() * another.getImag()), (this.getReal()
				* another.getImag() + this.getImag() * another.getReal())));
	}
